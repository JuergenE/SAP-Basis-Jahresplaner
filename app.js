...
const SeriesPopupEditor = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "px-3 py-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-300 dark:border-blue-800 rounded text-sm hover:bg-blue-200 dark:hover:bg-blue-900/50 font-medium transition-colors"
  }, "+ Termin hinzuf\xFCgen"), /*#__PURE__*/React.createElement("label", {
    className: "cursor-pointer px-3 py-1.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border border-purple-300 dark:border-purple-800 rounded text-sm hover:bg-purple-200 dark:hover:bg-purple-900/50 font-medium transition-colors flex items-center justify-center"
